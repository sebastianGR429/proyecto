...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/imagen_inicio.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <article>
      <h3 class="heading">¿POR QUE ESCOGER CHIBCHA WEB?</h3>
      <p>Ademas de ofrecerte una palicación amigable, donde enocntraras las mejores empresas de registro de dominio
      asociadas con nosotros y en donde podras hacer los tramites de solicitud para alojar con alguna de ellas o por que no
      con nosotros mismos, no esperes mas y unete a la familia chibcha web, te esperamos!.
      </p>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="registro.php">Unirme</a></li>
        </ul>
      </footer>
    </article>
