	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Informacion Distribuidor</h4>
			...
			<div class="modal-body">
				...
				<form role="form">
					...
					<div class="form-group">
						...
						<input class="form-control" id="cantidad_dominios" />
					</div>
				</form>
			</div>
						...
						?>
							<tbody>
								<tr>
									...
									<td>
										<button type="button" class="btn btn-success Cliente">Ver distribuidor</button>
									</td>
								</tr>
